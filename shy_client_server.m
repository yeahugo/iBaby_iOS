...
- (id) initWithId: (int32_t) id url: (NSString *) url img: (NSString *) img title: (NSString *) title resourceType: (int) resourceType fileType: (int) fileType desc: (NSString *) desc durationTime: (int32_t) durationTime releaseTime: (int32_t) releaseTime childAge: (int32_t) childAge language: (NSString *) language tags: (NSString *) tags curEpisode: (int32_t) curEpisode totalEpisode: (int32_t) totalEpisode albumId: (NSString *) albumId vid: (NSString *) vid
{
  ...
  __tags_isset = YES;
  __curEpisode = curEpisode;
  __curEpisode_isset = YES;
  __totalEpisode = totalEpisode;
  __totalEpisode_isset = YES;
  __albumId = [albumId retain_stub];
  __albumId_isset = YES;
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  if ([decoder containsValueForKey: @"curEpisode"])
  {
    __curEpisode = [decoder decodeInt32ForKey: @"curEpisode"];
    __curEpisode_isset = YES;
  }
  if ([decoder containsValueForKey: @"totalEpisode"])
  {
    __totalEpisode = [decoder decodeInt32ForKey: @"totalEpisode"];
    __totalEpisode_isset = YES;
  }
  if ([decoder containsValueForKey: @"albumId"])
  {
    __albumId = [[decoder decodeObjectForKey: @"albumId"] retain_stub];
    __albumId_isset = YES;
  }
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  ...
  if (__curEpisode_isset)
  {
    [encoder encodeInt32: __curEpisode forKey: @"curEpisode"];
  }
  if (__totalEpisode_isset)
  {
    [encoder encodeInt32: __totalEpisode forKey: @"totalEpisode"];
  }
  if (__albumId_isset)
  {
    [encoder encodeObject: __albumId forKey: @"albumId"];
  }
  if (__vid_isset)
  {
...
- (BOOL) curEpisodeIsSet {
  return __curEpisode_isset;
}

- (void) unsetCurEpisode {
  __curEpisode_isset = NO;
}

- (int32_t) totalEpisode {
  return __totalEpisode;
}
...
- (BOOL) totalEpisodeIsSet {
  return __totalEpisode_isset;
}

- (void) unsetTotalEpisode {
  __totalEpisode_isset = NO;
}

- (NSString *) albumId {
  return [[__albumId retain_stub] autorelease_stub];
}
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      ...
      case 14:
        if (fieldType == TType_I32) {
          int32_t fieldValue = [inProtocol readI32];
          [self setTotalEpisode: fieldValue];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
        break;
...
- (void) write: (id <TProtocol>) outProtocol {
  ...
  if (__curEpisode_isset) {
    [outProtocol writeFieldBeginWithName: @"curEpisode" type: TType_I32 fieldID: 13];
    [outProtocol writeI32: __curEpisode];
    [outProtocol writeFieldEnd];
  }
  if (__totalEpisode_isset) {
    [outProtocol writeFieldBeginWithName: @"totalEpisode" type: TType_I32 fieldID: 14];
    [outProtocol writeI32: __totalEpisode];
    [outProtocol writeFieldEnd];
  }
  if (__albumId_isset) {
    if (__albumId != nil) {
      [outProtocol writeFieldBeginWithName: @"albumId" type: TType_STRING fieldID: 15];
      [outProtocol writeString: __albumId];
      [outProtocol writeFieldEnd];
    }
  }
  if (__vid_isset) {
...
- (NSString *) description {
  ...
  [ms appendString: @",curEpisode:"];
  [ms appendFormat: @"%i", __curEpisode];
  [ms appendString: @",totalEpisode:"];
  [ms appendFormat: @"%i", __totalEpisode];
  [ms appendString: @",albumId:"];
  [ms appendFormat: @"\"%@\"", __albumId];
  [ms appendString: @",vid:"];
    ...
    switch (fieldID)
    {
      ...
      case 2:
        if (fieldType == TType_LIST) {
          ...
          {
            int32_t _elem12 = [inProtocol readI32];
            [fieldValue addObject: [NSNumber numberWithLong: _elem12]];
          }
          [inProtocol readListEnd];
  ...
  if (__resourceIds_isset) {
    if (__resourceIds != nil) {
      [outProtocol writeFieldBeginWithName: @"resourceIds" type: TType_LIST fieldID: 2];
      {
        ...
        int i14;
        for (i14 = 0; i14 < [__resourceIds count]; i14++)
        {
          [outProtocol writeI32: [[__resourceIds objectAtIndex: i14] longValue]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
    ...
    switch (fieldID)
    {
      ...
      case 2:
        if (fieldType == TType_LIST) {
          ...
          {
            ResourcesWatched *_elem17 = [[ResourcesWatched alloc] init];
      ...
      case 3:
        if (fieldType == TType_LIST) {
          ...
          {
            ResourceSelected *_elem20 = [[ResourceSelected alloc] init];
  ...
  if (__watchRecord_isset) {
    if (__watchRecord != nil) {
      [outProtocol writeFieldBeginWithName: @"watchRecord" type: TType_LIST fieldID: 2];
      {
        ...
        int i22;
        for (i22 = 0; i22 < [__watchRecord count]; i22++)
        {
          [[__watchRecord objectAtIndex: i22] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__selectRecord_isset) {
    if (__selectRecord != nil) {
      [outProtocol writeFieldBeginWithName: @"selectRecord" type: TType_LIST fieldID: 3];
      {
        ...
        int i24;
        for (i24 = 0; i24 < [__selectRecord count]; i24++)
        {
          [[__selectRecord objectAtIndex: i24] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__resourceList_isset) {
    if (__resourceList != nil) {
      [outProtocol writeFieldBeginWithName: @"resourceList" type: TType_LIST fieldID: 1];
      {
        ...
        int i29;
        for (i29 = 0; i29 < [__resourceList count]; i29++)
        {
          [outProtocol writeI32: [[__resourceList objectAtIndex: i29] longValue]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
    ...
    switch (fieldID)
    {
      case 1:
        if (fieldType == TType_LIST) {
          ...
          {
            ResourceInfo *_elem32 = [[ResourceInfo alloc] init];
  ...
  if (__infoList_isset) {
    if (__infoList != nil) {
      [outProtocol writeFieldBeginWithName: @"infoList" type: TType_LIST fieldID: 1];
      {
        ...
        int i34;
        for (i34 = 0; i34 < [__infoList count]; i34++)
        {
          [[__infoList objectAtIndex: i34] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
...
@implementation shy_client_serverConstants
+ (void) initialize {
}
@end
